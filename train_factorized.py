"""
python train_factorized.py --model="models.model_voxception" --alpha=4 --beta=3 \
...
parser.add_argument(
    "--model", default="models.model_voxception",
    help="model name.")
parser.add_argument(
...
# file_list = sorted(glob.glob('../points64_part1/'+'*.h5')+glob.glob('../points64_part2/'+'*.h5'))
