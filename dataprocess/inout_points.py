...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input",
        type=str,
        default="../../testdata/8iVFB/redandblack_vox10_1550_n.ply",
        dest="input",
    )
    parser.add_argument("--output", type=str, default="rec.ply", dest="output")
    parser.add_argument(
        "--cube_size",
        type=int,
        default=64,
    ...
    ################### inout #########################
    set_points, cube_positions = load_points(
        args.input, cube_size=args.cube_size, min_num=args.min_num
    )
