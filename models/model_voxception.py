...
class _VoxceptionResNet(tf.keras.Model):
  ...
  """
    ...
    def __init__(self, num_filters, name, activation=tf.nn.relu):
        ...
        # path_1
        self.conv1_1 = tf.keras.layers.Conv3D(
            int(num_filters / 4),
            (3, 3, 3),
            padding="same",
        ...
        self.conv1_2 = tf.keras.layers.Conv3D(
            int(num_filters / 2),
            (3, 3, 3),
            padding="same",
            activation=activation,
        ...
        # path_2
        self.conv2_1 = tf.keras.layers.Conv3D(
            int(num_filters / 4),
            (1, 1, 1),
            padding="same",
            activation=activation,
        ...
        self.conv2_2 = tf.keras.layers.Conv3D(
            int(num_filters / 4),
            (3, 3, 3),
            padding="same",
            activation=activation,
        ...
        self.conv2_3 = tf.keras.layers.Conv3D(
            int(num_filters / 2),
            (1, 1, 1),
            padding="same",
            activation=activation,
...
class AnalysisTransform(tf.keras.Model):
  ...
  """
    ...
    def __init__(self):
        ...
        self.conv_in = tf.keras.layers.Conv3D(
            16,
            (3, 3, 3),
            padding="same",
        ...
        self.down_1 = tf.keras.layers.Conv3D(
            32,
            (3, 3, 3),
            (2, 2, 2),
            padding="same",
        ...
        self.down_2 = tf.keras.layers.Conv3D(
            64,
            (3, 3, 3),
            (2, 2, 2),
            padding="same",
        ...
        self.conv_out = tf.keras.layers.Conv3D(
            16, (3, 3, 3), padding="same", use_bias=True, name="conv_out"
        )
...
class SynthesisTransform(tf.keras.Model):
    def __init__(self):
        ...
        self.deconv_in = tf.keras.layers.Conv3D(
            64,
            (3, 3, 3),
            padding="same",
            activation=tf.nn.relu,
        ...
        self.up_1 = tf.keras.layers.Conv3DTranspose(
            32,
            (3, 3, 3),
            (2, 2, 2),
            padding="same",
        ...
        self.up_2 = tf.keras.layers.Conv3DTranspose(
            16,
            (3, 3, 3),
            (2, 2, 2),
            padding="same",
        ...
        #
        self.deconv_out = tf.keras.layers.Conv3D(
            1, (3, 3, 3), padding="same", use_bias=True, name="deconv_out"
        )
  ...
  """
    ...
    def __init__(self, activation=tf.nn.relu):
        ...
        self.conv3 = tf.keras.layers.Conv3D(
            8, (3, 3, 3), padding="same", activation=None, use_bias=True, name="conv3"
        )
...
class HyperDecoder(tf.keras.Model):
  ...
  """
    ...
    def __init__(self, activation=tf.nn.relu):
        ...
        self.conv4_1 = tf.keras.layers.Conv3D(
            16,
            (3, 3, 3),
            padding="same",
            activation=None,
        ...
        self.conv4_2 = tf.keras.layers.Conv3D(
            16,
            (3, 3, 3),
            padding="same",
            activation=None,
